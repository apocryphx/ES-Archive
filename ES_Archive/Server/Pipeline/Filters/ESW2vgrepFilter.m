...
+ (NSString *)manPage {
    return
        ...
        @"    because both vectors are full-summary embeddings — identical\n"
        @"    summaries reach ~1.0 there. Read 0.85+ as near-duplicate and\n"
        @"    0.55–0.85 as closely related. For w2vgrep, 0.85+ usually means\n"
        @"    the query closely mirrors a stored summary.\n"
        @"\n"
        @"EXAMPLES\n"
