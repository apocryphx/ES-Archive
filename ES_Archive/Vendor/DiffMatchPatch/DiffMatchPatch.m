 ...
 * @param text1 Old NSString to be diffed.
 * @param text2 New NSString to be diffed.
 * @param properties DiffProperties struct: checkLines is a speedup flag (if NO,
 *     don't run a line-level diff first to identify the changed areas; if YES,
 *     run a faster slightly less optimal diff); deadline is the time the diff
 ...
 * @param text1 Old NSString to be diffed.
 * @param text2 New NSString to be diffed.
 * @param properties DiffProperties struct; deadline is the time when the diff
 *     should be complete by.
 * @return NSMutableArray of Diff objects.
 */
 ...
 * @param properties DiffProperties struct; deadline is the time at which to bail
 *     if not yet complete.
 * @return NSMutableArray of Diff objects.
 */
 ...
 * of text.
 * @param diffs NSArray of DMDiff objects, passed by reference.
 ...
 * @param inputDiffs NSMutableArray of Diff objects, passed by reference.
 */
 ...
 * @param mutableDiffs NSMutableArray of Diff objects, passed by reference.
 */
