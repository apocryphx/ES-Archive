...
void diff_charsToLines(NSArray * _Nonnull * _Nonnull diffs, NSArray *lineArray);
void diff_charsToTokens(NSArray * _Nonnull * _Nonnull diffs, NSArray *tokenArray);
...
void diff_cleanupSemantic(NSMutableArray * _Nonnull * _Nonnull diffs);
void diff_cleanupMerge(NSMutableArray * _Nonnull * _Nonnull diffs);
void diff_cleanupSemanticLossless(NSMutableArray * _Nonnull * _Nonnull diffs);
...
NSString *patch_applyPatchesToTextWithProperties(NSArray *sourcePatches, NSString *text, NSIndexSet * _Nullable * _Nullable indexesOfAppliedPatches, PatchProperties properties);

NSString * _Nullable patch_addPaddingToPatches(NSMutableArray * _Nonnull * _Nullable patches, PatchProperties properties);
void patch_splitMax(NSMutableArray * _Nonnull * _Nonnull patches, PatchProperties properties);
void patch_cleanupDiffsForEfficiency(NSMutableArray * _Nonnull * _Nonnull diffs, PatchProperties properties);


// A convenience function to splice two arrays, likely of DMDiffs or DMPatches
void diff_spliceTwoArrays(NSMutableArray * _Nonnull * _Nullable input, NSUInteger start, NSUInteger count, NSArray * _Nullable objects);
