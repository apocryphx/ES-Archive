...
NSArray * _Nullable diff_diffsFromOriginalTextAndDelta(NSString *text1, NSString *delta, NSError * _Nullable * _Nullable error);
...
NSArray * _Nullable patch_parsePatchesFromText(NSString *text, NSError * _Nullable * _Nullable error);
...
NSString *patch_applyPatchesToText(NSArray *sourcePatches, NSString *text, NSIndexSet * _Nullable * _Nullable indexesOfAppliedPatches);
